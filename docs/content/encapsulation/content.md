...
Design guideline:
Looking for main nouns, classes are often described by main nouns in the problem.
Looking for auxiliary nouns that describe details of the main noun, Fields or Attributes are often described by auxiliary nouns.
Looking for verbs, methods or behaviors are often described by verbs.
Find the relationship among classes. TIPS: If your problem has two main nouns. They have often the relationship.
...
Demo Car ClassOutput Car Class
Constructor
